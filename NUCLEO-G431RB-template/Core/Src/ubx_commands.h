...
typedef enum {
    ...
    UBX_CLASS_ACK = 0x05,     /**< Ack/Nack Messages (Acknowledgment/Rejection) */
    UBX_CLASS_CFG = 0x06,     /**< Configuration Input Messages */
    UBX_CLASS_UPD = 0x09,     /**< Firmware Update Messages */
    UBX_CLASS_MON = 0x0a,     /**< System Monitoring Messages */
    UBX_CLASS_AID = 0x0b,     /**< (Deprecated) */
    ...
    UBX_CLASS_HNR = 0x28,     /**< High Rate Navigation Messages  */
    UBX_CLASS_NMEA = 0xf0,    /**< NMEA prefix for configuration messages */
    UBX_CLASS_RTCM3 = 0xf5,   /**< RTCM prefix for configuration messages */
} ubx_classes_t;
